...
# a config file.
# 
# - citation2latex - strip_ansi - escape_latex - filter_data_type - markdown2rst
# - strip_files_prefix - wrap_text - highlight2html - indent - html2text -
# markdown2html - path2url - ipython2python - ansi2html - add_anchor - get_lines
# - add_prompts - markdown2latex - strip_dollars - comment_lines - posix_path -
# ascii_only - highlight2latex - ansi2latex
...
# 
# c.ExtractOutputPreprocessor.extract_output_types = {'application/pdf', 'jpeg', 'svg', 'png'}
